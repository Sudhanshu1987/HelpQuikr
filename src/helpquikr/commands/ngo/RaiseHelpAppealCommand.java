...
public class RaiseHelpAppealCommand extends AbstractCommand {

	private static final Logger logger = Logger.getLogger(RaiseHelpAppealCommand.class.getName());
	public RaiseHelpAppealCommand(Message message, RequestHandler requestHandler) {
